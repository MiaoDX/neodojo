...
| [mvp-gvhmr-operator-package.md](mvp-gvhmr-operator-package.md) | implemented collocated operator package; real artifact still external | Validated package directory that collocates the archive, run request, Colab notebook, and package README/manifest for the external GPU operator. |
