...
production teaching UI，或 GMR-driven 的真实 Unitree G1 mesh playback。
...
`unitreerobotics/unitree_mujoco` `g1_29dof.xml` clone 验证。
...
- [ ] 把 imported GMR joint angles 应用到真实 Unitree G1 MuJoCo qpos
