...
package、operator package archive、GPU execution probe、real-artifact intake
smoke artifacts，上传默认 real-conversion audit 与 opt-in GitHub-route audit
artifacts，以及 public-demo、browser-capture 与 capture-bundle artifacts，并在
