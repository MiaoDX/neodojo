...
本机 real GVHMR proof 只存在于 ignored `outputs/` 下。当前命令面不再支持 Colab、
hosted GPU provider、self-hosted Actions GPU、operator-package，或 real-demo
Pages-promotion workflows。
