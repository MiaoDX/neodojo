...
但还没有提交到仓库的 GVHMR/GMR 执行 pipeline、仿真器运行时 pipeline、内置 official SMPL-X body-model renderer、
production live-client Viser capture，或 end-to-end 的真实 generated motion
artifact。
