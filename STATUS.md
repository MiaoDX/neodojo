...
- Optional MuJoCo offscreen render evidence generated by `render mujoco-g1`
  ...
  The built-in optional smoke verifies the path with a tiny MJCF model; final
  real Unitree G1 mesh proof still needs user-supplied G1 assets.
...
- Final MuJoCo real Unitree G1 mesh proof from local G1 URDF/MJCF plus meshes:
